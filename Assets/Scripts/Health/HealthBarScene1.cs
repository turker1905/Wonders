...
public class HealthBarScene1 : MonoBehaviour
{
    ...
    [SerializeField] Text _deadUITExt,_kullaniciAdiText;
    string _nickname;
    ...
    void Update()
    {
        _toplamSkor = _main.GetComponent<Skorr>()._sonuc;
        
    }

    private void LateUpdate()
    {
        _nickname = _kullaniciAdiText.text;
    }
}
